    ...
    <Link to={'/detail-order'} style={{ textDecoration: 'none', color: 'white' }}>
      <Box mb={'20px'}>
        <Box display={'flex'} justifyContent={'space-between'} p={2} border={"1px #e6e4e5 solid"} borderRadius={"10px"}>
          <Box>
            <Typography p={1} bgcolor={'#008f5d'} sx={{ fontWeight: 'bolder', width: 'fit-content', borderRadius: '10px', color: 'white' }} mb={1}>Pesanan Baru</Typography>
            <Typography color={'#909090'}>INV/20230809/MPL/00000239</Typography>
          </Box>
          <Box>
            <Button sx={{ border: 'gray solid 1px', borderRadius: '30px', fontWeight: 'bolder', color: 'black' }}>Proses Pesanan</Button>
          </Box>
        </Box>
        <Box
          display={"flex"}
...
export default StatusCardNewOrder