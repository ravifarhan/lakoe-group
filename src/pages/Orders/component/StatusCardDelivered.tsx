    ...
    <Link to={'/detail-order'} style={{ textDecoration: 'none' }}>
      <Box mb={'20px'}>
        <Box display={'flex'} justifyContent={'space-between'} p={2} border={"1px #e6e4e5 solid"} borderRadius={"10px"}>
          <Box>
            <Typography p={1} bgcolor={'#e6e6e6'} sx={{ fontWeight: 'bolder', width: 'fit-content', borderRadius: '10px', color: 'black' }} mb={1}>Pesanan Selesai</Typography>
